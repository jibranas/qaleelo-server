(this["webpackJsonpquran-app"] = this["webpackJsonpquran-app"] || []).push([
  [0],
  {
    ...
    455: function (e, n, t) {
          ...
          function (e) {
            ...
            L.sections &&
              L.sections.map(function (e) {
                return P.push(e.sectionNumber);
              }),
              console.log(P);
            var V = Math.ceil(100 / P.length);
            console.log(V);
            var q = [],
              W = [],
              G = [],
            ...
            P.map(function (e) {
              ...
              console.log(n),
                n.length > V
                  ? ((q = J(n, V)), console.log(q), (G = W.concat(G, q)))
                  : (G = W.concat(G, n)),
                console.log(W),
                console.log(G);
            }),
      ...
      p.b.div(Vn()), p.b.div(Pn()), p.b.input(Hn()), p.b.div(Yn());
      function qn(e) {
        var n = b(),
          t = n.subContainer;
        n.courseTitleUserIsOn,
      ...
      var ot = p.b.div(tt()),
        rt = p.b.div(nt()),
        at = Object(p.b)(Re.a.div)(et(), function (e) {
          return e.answerClicked == e.answer ? e.answerColor : "#D2CFE6";
        }),
        ct = p.b.div(Zn(), function (e) {
          return e.answerClicked == e.answer ? "flex" : "none";
        }),
        st = function (e) {
          console.log(e);
        ...
        dt = function (e) {
          ...
          return (
            Object(r.useEffect)(
              function () {
                if (a > 0) {
                  var e = document.getElementById("section-".concat(a - 1));
                  e && e.scrollIntoView({ behavior: "smooth" });
                }
              },
              [a]
      ...
      s.a.render(
        Object(o.jsx)("div", {
          children: Object(o.jsx)(f, { children: Object(o.jsx)(bt, {}) }),
        }),
...
//# sourceMappingURL=main.e9feadf1.chunk.js.map
