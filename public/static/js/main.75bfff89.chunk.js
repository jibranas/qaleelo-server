  ...
  [0],
  {
    ...
    453: function (e, n, t) {
      ...
      function f(e) {
        ...
        Object(r.useEffect)(
          function () {
            localStorage.setItem("preferredMode", V ? "dark" : "light");
          },
          [V]
        ),
        ...
        Ln =
          ...
          function (e) {
            ...
            P.map(function (e) {
              ...
              console.log(n),
                n.length > q
                  ? ((V = J(n, q)), console.log(V), (G = W.concat(G, V)))
                  : (G = W.concat(G, n)),
                console.log(W),
                console.log(G);
            }),
      ...
      p.b.div(qn()), p.b.div(Pn()), p.b.input(Hn()), p.b.div(Yn());
      function Vn(e) {
        var n = b(),
          t = n.subContainer;
        n.courseTitleUserIsOn,
...
//# sourceMappingURL=main.75bfff89.chunk.js.map
