  ...
  [0],
  {
    ...
    176: function (e) {
      e.exports = JSON.parse(
        '{"sectionNumber":"1.1.1","sectionTitle":"The Quran is easy","sectionDescription":"Allah Subhanau wa Ta\u2019la says in the Quran:\\n\\n\u0641\u064e\u0671\u0639\u0652\u0644\u064e\u0645\u0652 \u0623\u064e\u0646\u0651\u064e\u0647\u064f\u06e5 \u0644\u064e\u0627\u0653 \u0625\u0650\u0644\u064e\u0640\u0670\u0647\u064e \u0625\u0650\u0644\u0651\u064e\u0627 \u0671\u0644\u0644\u0651\u064e\u0647\u064f \\n\\nSo know, [O Muhammad], that there is no deity except Allah.\'    \\n\\nSurat Muhammad: Ayah 19.  \\n\\nSo what is the very important thing that every Muslim should know? It is to understand and implement Kalima Tawheed, or the words  \u0644\u0627 \u0625\u0644\u0647 \u0625\u0644\u0627 \u0627\u0644\u0644\u0647.","sectionNotes":["It is a direct command from Allah to learn about Tawheed, and so if you learn about Tawheed you are obeying Allah."],"lessonAnimation":[{"className":"verticalSection","style":{"marginBottom":"0","paddingBottom":"0","paddingRight":"0","paddingLeft":"0"},"subSections":[{"className":"YouTubeVideo","videoLink":"https://www.youtube.com/embed/cVQjdCeadhc?si=XvDwIaQyrceiSNFb?start=0&end=310&autoplay=1","style":{"width":"100%","zIndex":2000},"initial":{"opacity":0,"scale":0},"animate":{"opacity":1,"scale":1},"exit":{},"transition":{"delay":0.5,"type":"spring","stiffness":260,"damping":20},"speed":2,"loop":false}]}]}'
      );
    },
    332: function (e, n, t) {},
    36: function (e, n, t) {},
    ...
    455: function (e, n, t) {
      ...
      function f(e) {
        ...
        var Q = Object(a.useState)({}),
          ...
          Y = R[1];
        console.log(A);
        var H = localStorage.getItem("preferredMode"),
          V = Object(a.useState)("dark" === H),
          P = Object(i.a)(V, 2),
          q = P[0],
          W = P[1];
        Object(a.useEffect)(
          function () {
            localStorage.setItem("preferredMode", q ? "dark" : "light");
          },
          [q]
        ),
      ...
      function A(e) {
        var n = b(),
          ...
          r = n.entryStore,
          c = n.isDarkMode,
          s = (n.setIsDarkMode, Object(a.useState)("")),
          l = Object(i.a)(s, 2),
          u = l[0],
          d = l[1],
          f = Object(a.useState)([]),
        ...
        return Object(o.jsxs)("div", {
          ...
          children: [
            ...
            Object(o.jsx)(S.a, {
              ...
              mountOnEnter: !0,
              children: function (n) {
                return Object(o.jsx)(A, { state: n, closeNav: e.click });
              },
            }),
            Object(o.jsx)(S.a, {
              in: t,
      ...
      var We = p.b.div(Ve()),
        ...
        Je = function (e) {
          var n = b(),
            ...
            m = Object(i.a)(f, 2),
            p = m[0],
            j = (m[1], Object(a.useState)("#e8e2ef")),
            h = Object(i.a)(j, 2),
            x = h[0],
            g = h[1],
      ...
      function wn(e) {
        ...
        var g = Object(a.useState)("0"),
          v = Object(i.a)(g, 2),
          N = (v[0], v[1], Object(a.useState)("0")),
          w = Object(i.a)(N, 2),
          y = (w[0], w[1], Object(a.useState)("0")),
          k = Object(i.a)(y, 2),
          C = (k[0], k[1], Object(a.useState)("0")),
          T = Object(i.a)(C, 2),
          E = (T[0], T[1], Object(a.useState)(0)),
          D = Object(i.a)(E, 2),
          z = D[0],
          L = D[1],
          I = window.scrollY;
          ...
          function (e) {
                ...
                if (l) {
                  ...
                  try {
                    for (o.s(); !(t = o.n()).done; ) {
                      ...
                      try {
                        for (c.s(); !(a = c.n()).done; ) {
                          if (a.value.topicNumber === e) {
                            (n = !0), console.log(e);
                            var s = r.entries.findIndex(function (n) {
                              return n.topicNumber === e;
                            });
                            console.log(s), console.log(r.title);
                            ...
                            if (
                              ...
                              console.log(r.topicHeaderNumber, i),
                              s !== r.entries.length - 1)
                            )
                              return r.entries[s + 1];
                            if (s == r.entries.length - 1 && i !== l.length - 1)
            ...
            F
              ? (console.log("Next Chapter Number:", F.entries[0].topicNumber),
                ...
                (A = F.entries[0].topicNumber),
                (B = F.entries[0].title),
                (M = F.entries[0].entries[0].sectionNumber),
            ...
            L.sections &&
              L.sections.map(function (e) {
                return V.push(e.sectionNumber);
              }),
              console.log(V);
            var P = Math.ceil(100 / V.length);
            console.log(P);
            var q = [],
              W = [],
              G = [],
            ...
            V.map(function (e) {
              ...
              console.log(n),
                n.length > P
                  ? ((q = X(n, P)), console.log(q), (G = W.concat(G, q)))
                  : (G = W.concat(G, n)),
                console.log(W),
                console.log(G);
            }),
            ...
            var J = g.reduce(function (e, n) {
                return e + n;
              }, 0),
              K = Math.round((J / g.length) * 100);
            return Object(o.jsx)(Me.Provider, {
              value: [g, v],
                        ...
                        children: [
                          ...
                          p
                            ? Object(o.jsx)(dn, {
                                ...
                                nextChapterNumber: A,
                                nextChapterTitle: B,
                                nextChapterFirstLessonNumber: M,
      ...
      p.b.div(Pn()), p.b.div(Vn()), p.b.input(Hn()), p.b.div(Yn());
      function qn(e) {
        var n = b(),
          t = n.subContainer;
        n.courseTitleUserIsOn,
                    ...
                    Object(o.jsxs)(_n, {
                      ...
                      children: [
                        ...
                        Object(o.jsx)(E.b, {
                          ...
                          style: { margin: "60px" },
                          children: Object(o.jsx)(Xn, { children: " Start" }),
                        }),
                      ],
                    }),
                    Object(o.jsx)(qn, {}),
      ...
      var at = p.b.div(ot()),
        ...
        it = function (e) {
          ...
          var n = b(),
            ...
            c = n.isDarkMode;
          console.log(r);
          var s = Object(a.useState)("#e8e2ef"),
            l = Object(i.a)(s, 2),
            u = l[0],
            d = l[1],
          ...
          return (
            Object(a.useEffect)(function () {
              var n = (function (n) {
                var t =
                  ...
                  e.exampleDatafromBackEnd.filter(function (e) {
                    return e.sectionNumber == n;
                  });
            ...
            Object(o.jsxs)(at, {
              className: "LessonExampleBox",
              children: [
                Object(o.jsx)(rt, { children: S && S.question }),
                I.map(function (e) {
                  return Object(o.jsxs)(o.Fragment, {
                    children: [
                      Object(o.jsx)(ct, {
      ...
      var dt = function (e) {
        ...
        bt = function (e) {
          var n = Object(a.useState)(-1),
            ...
            N = b(),
            w = N.courseDetails,
            y = N.setCourseDetails,
            k = N.courseTitleUserIsOn,
          ...
          var L = (function (e, n) {
            ...
            F = "";
          L
            ? (console.log("Chapter Title:", L.chapterTitle),
              console.log("Chapter Number:", L.chapterNumber),
              (I = L.chapterTitle),
              (F = L.chapterNumber))
          ...
          var B = e.match.params.lessonNumber;
          console.log(B),
            console.log(w.courseTopicsCollectionName),
            console.log(w.courseTopicsModelName),
            Object(a.useEffect)(
              function () {
                u()(
                  "/"
                    ...
                    .concat(w.courseTopicsCollectionName, "&modelName=")
                    .concat(w.courseTopicsModelName)
                ).then(function (e) {
                  f(Zn);
                });
              },
          ...
          Object(a.useEffect)(
            function () {
              u()(
                "/examplesData?collectionName="
                  .concat(w.courseExamplesCollectionName, "&modelName=")
                  .concat(w.courseExamplesModelName)
              ).then(function (e) {
                R(e.data), console.log(e.data);
              });
            },
          ...
          Object(a.useEffect)(
            function () {
              if (v) {
                var e = document.getElementById("lessonExample");
          ...
          return (
            Object(a.useEffect)(
              function () {
                if (r > 0) {
                  var e = document.getElementById("section-".concat(r - 1));
                  e && e.scrollIntoView({ behavior: "smooth" });
                }
              },
              [r]
                                    ...
                                    : Object(o.jsx)(
                                        Re.a.div,
                                        {
                                          ...
                                          children: e.subSections.map(function (
                                            ...
                                            return "YouTubeVideo" == e.className
                                              ? Object(o.jsx)("div", {
                                                  style: e.style,
                                                  children: Object(o.jsx)(
                                                    "div",
                            ...
                            d.lessonAnimation &&
                              ...
                              Object(o.jsx)(Re.a.div, {
                                ...
                                children: Object(o.jsx)(it, {
                                  ...
                                  chapterNumber: F,
                                  chapterTitle: I,
                                  lessonNumber: d.sectionNumber,
                                  exampleDatafromBackEnd: Q,
                                }),
                              }),
                            Object(o.jsx)("div", {
...
//# sourceMappingURL=main.15018308.chunk.js.map
